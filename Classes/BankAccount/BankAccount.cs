...
namespace BankAccount
{
    ...
    {
        private static List<int> _accountSeeds;
        ...
        private int GenerateRandomAccountSeed()
        {
            Random random = new Random();

            int randomNum = random.Next(0, 1000000);
            while (_accountSeeds.Contains(randomNum))
            {
                randomNum = random.Next(0, 1000000);
            }

            _accountSeeds.Add(randomNum);
        ...
        {
            Number = GenerateRandomAccountSeed();
